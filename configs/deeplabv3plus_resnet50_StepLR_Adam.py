...
config = dict(
    ...
    #                           
    train_pipeline = dict(
        dataloader = dict(batch_size = 32,num_workers = 12,drop_last = True,pin_memory=True,shuffle=True),
    ...
    test_image3_pipeline = dict(
        dataloader = dict(batch_size = 16,num_workers = 12,drop_last = False,pin_memory=True,shuffle=False),
    ...
    model = dict(
        ...
        backbone = dict(type="resnet50",pretrained=True,replace_stride_with_dilation=[False,False,2]),
